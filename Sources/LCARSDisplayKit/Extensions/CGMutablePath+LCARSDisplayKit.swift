...
extension CGMutablePath {
    ...
    ///
    /// This is a convenience method that will automatically convert the provided
    /// `Degree`s to `Radian`s required for the **CoreGraphics** framework.
    ///
    /// - parameters:
    ///   - center: The center of the arc, in user space coordinates.
    ///   - radius: The radius of the arc, in user space coordinates.
    ///   - startDegree: The angle to the starting point of the arc, measured in degrees from the positive x-axis.
    ///   - endDegree: The angle to the end point of the arc, measured in degrees from the positive x-axis.
