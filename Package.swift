...
let package = Package(
    ...
    products: [
        ...
        .library(name: "LCARSDisplayKitUI", targets: ["LCARSDisplayKitUI"]),
        .library(name: "LCARSDisplayKitViews", targets: ["LCARSDisplayKitViews"]),
        ],
    dependencies: [
    ...
    targets: [
        ...
        .target(name: "LCARSDisplayKitUI", dependencies: ["GraphPoint", "LCARSDisplayKit"], path: "Sources/LCARSDisplayKitUI"),
        .target(name: "LCARSDisplayKitViews", dependencies: ["GraphPoint", "LCARSDisplayKit", "LCARSDisplayKitUI"], path: "Sources/LCARSDisplayKitViews"),
